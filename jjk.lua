...
local function loadScript()
    print("Loading Vehicle Boost System with Auto-Save & Bypass System & Easy Turn/Steering...")
    ...
    local function createBoostGui()
        ...
        local toggles = {
            createToggle("Easy Turn/Steering", boostConfig.EASY_TURN, function(v) 
                ...
                -- If boost is active and setting changed, update steering lock state
                if boosting and currentSeat then
                    if v then -- Easy Turn ON - unlock steering
                        unlockSteering(currentSeat)
                    else -- Easy Turn OFF - lock steering if boosting
                        if boosting then
    ...
    print("Vehicle Boost System with Auto-Save & Easy Turn/Steering loaded successfully")
end
        ...
        if ok then
            ...
            pcall(function()
                if setclipboard then
                    setclipboard("https://discord.gg/ab4eTtTg")
                end
            end)

...
local function disableReduceLag()
    ...
    local function applyButtonTransparency(value)
    boostConfig.BUTTON_TRANSPARENCY = value

    if boostBtn then
        boostBtn.BackgroundTransparency = value
        boostBtn.TextTransparency = value
    end

    if settingsBtn then
        settingsBtn.BackgroundTransparency = value
        settingsBtn.TextTransparency = value
    end
end
    ...
    0,
    1,
    boostConfig.BUTTON_TRANSPARENCY,
    function(v)
        applyButtonTransparency(v)
    end
),
        ...
        local function setUILock(state)
            ...
            boostBtn.BackgroundTransparency = state and 0.5 or 0
            settingsBtn.BackgroundTransparency = state and 0.5 or 0
        end
        ...
        return gui, boostBtn, settingsBtn, lockBtn
    end
    ...
    local function setupBoost(character)
        ...
        local gui, boostBtn, settingsBtn, lockBtn = createBoostGui()
        applyButtonTransparency(boostConfig.BUTTON_TRANSPARENCY)
